  ...
  return (
    <div className="absolute left-0 right-0 top-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center   ">
      ...
      >
        ...
        {state === "Sign Up" && isTextDataSubmitted ? (
          <>
            <div className="flex items-center gap-4 my-10">
              <label htmlFor="image">
                <img
                  className="w-16 h-20 object-cover rounded-full cursor-pointer"
        ...
        <button
          type="submit"
          className=" bg-blue-600 w-full cursor-pointer hover:bg-blue-500 text-white py-2 rounded-full mt-5"
        >
          {state === "Login"
            ? "Login"
            : isTextDataSubmitted
