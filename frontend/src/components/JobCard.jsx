  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
      ...
      <div className="flex gap-4">
        <button className="bg-blue-600 text-white font-medium py-2 px-4 rounded-md hover:bg-blue-700 transition-colors duration-200">
          Apply now
        </button>
        <button className="bg-white text-gray-800 border border-gray-300 font-medium py-2 px-4 rounded-md hover:bg-gray-50 transition-colors duration-200">
          Learn more
        </button>
      </div>
    </div>
