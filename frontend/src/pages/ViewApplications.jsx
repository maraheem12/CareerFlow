            ...
            <td className='py-2 border-gray-200 px-4 border-b relative'>
              <div className='relative inline-block text-left group'>
                ...
                <div className='z-10 hidden absolute right-0 left-0 top-0 mt-2 w-32 bg-white border-gray-200 rounded shadow group-hover:block'>
                  <button className='block w-full text-left px-4 py-2 text-blue-100 hover:bg-gray-100'>Accept</button>
                  <button className='block w-full text-left px-4 py-2 text-red-100 hover:bg-gray-100'>Reject</button>
                </div>
              </div>
            </td>
          </tr>
          ...
          <tbody>
            {viewApplicationsPageData.map((applicant, index)=>(
              <tr key={index} className='text-gray-700 ' >
                ...
                <td className='py-2 px-4 border-b  text-center flex max-sm:hidden'>
                  {applicant.jobTitle}
                </td>
                <td className='py-2 px-4 border-b  text-center flex max-sm:hidden' >
                  {applicant.location}
                ...
                <td className='py-2 px-4 border-b relative  ' >
                  <div className='relative inline-block text-left group  ' >
                    ...
                    <div className='z-10 hidden absolute right-0 left-0 top-0 mt-2 w-32 bg-white border-gray-200 rounded shadow group-hover:block ' >
                      <button className='block w-full text-left px-4 py-2 text-blue-100 hover:bg-gray-100 ' >Accept</button>
                      <button className='block w-full text-left px-4 py-2 textred-100 hover:bg-gray-100 '>Reject</button>
                    </div>
                  </div>
                </td>
              </tr>
